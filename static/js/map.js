...
d3.json("https://api.thedogapi.com/v1/breeds").then(function (response) {
    ...
    // Will need to assign variables for origin - can not pull from the json file 

    var markers = []
    for (let i = 0; i < response.length; i++) {
        var popupContent = `<div><center><img src="${response[i].image.url.split(',')}" class=popup-img width="180" height=auto></center> <center>
